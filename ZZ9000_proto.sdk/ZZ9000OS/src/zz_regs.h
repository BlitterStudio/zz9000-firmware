...
enum zz_reg_offsets {
  ...
  REG_ZZ_VIDEOCAP_DIAG_FLAGS = 0x62,
  REG_ZZ_VIDEOCAP_DIAG_Y3MAX = 0x64,
  REG_ZZ_VIDEOCAP_DIAG_YSYNC_MAX = 0x66,
  REG_ZZ_VIDEOCAP_DIAG_XLEN = 0x68,
  REG_ZZ_VIDEOCAP_DIAG_PHASE = 0x6A,
  REG_ZZ_VIDEOCAP_DIAG_RISELINES = 0x6C,
  REG_ZZ_VIDEOCAP_DIAG_FALLLINES = 0x6E,
