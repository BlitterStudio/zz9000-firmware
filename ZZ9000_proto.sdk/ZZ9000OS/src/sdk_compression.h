 ...
 * cold-reset mid-decode. Call from core 0 (core1_cold_restart, or the
 * scheduler's single-core fallback) while core 1 is halted and after the
 * malloc lock has been reset. Returns blocks reclaimed
