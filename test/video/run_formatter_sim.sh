...
2 0 2 720 0 0 0 0 0
1 0 2 62 0 0 0 0 0
2 0 0 1920 0 0 0 0 0
2 0 2 1280 16 32 0 0 0
2 0 0 64 0 0 1 0 0
2 0 1 64 0 0 1 0 0
2 0 0 64 0 0 0 1 0
1 0 0 64 0 0 0 1 0
...
# Optional focused matrix for local iteration; the default remains the full
# authoritative sweep above.
if [ -n "${FORMATTER_CONFIGS:-}" ]; then
